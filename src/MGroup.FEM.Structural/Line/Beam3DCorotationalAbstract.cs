...
{
	public abstract class Beam3DCorotationalAbstract : IStructuralElementType, IEmbeddedElement
	{
		...
		protected Beam3DCorotationalAbstract(IReadOnlyList<INode> nodes, double youngModulus, double poissonRatio, double density, BeamSection3D beamSection)
		{
			this.Nodes = nodes;
